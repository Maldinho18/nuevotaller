...
export const dataSeries = [
    new Serie (1,"Breaking Bad","AMC", 5, "https://i.imgur.com/GGje0vc.jpg", 
    ...
    new Serie (2,"Orange Is the New Black", "Netflix", 6, "https://i.imgur.com/EvKe48G.jpg", 
    ...
    new Serie (3, "Game of Thrones","HBO", 7, "https://i.imgur.com/TDCEV1S.jpg", "American fantasy drama", 
        "https://www.hbo.com/game-of-thrones",),
    
    new Serie (4, "The Big Bang Theory", "CBS", 12, "https://i.imgur.com/uAEpVWk.jpg",
    ...
    new Serie (5, "Sherlock", "BBC",  4, "https://i.imgur.com/02B7qhj.jpg", 
    ...
    new Serie (6, "A Very English Scandal", "BBC", 2, "https://i.imgur.com/D4y3DrQ.jpg", "A Very English Scandal is a fact-based three-part British television comedy-drama miniseries based on John Preston's book of the same name.",
